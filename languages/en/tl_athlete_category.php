 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_athlete_category']['title_legend']     = 'Title and Alias';
$GLOBALS['TL_LANG']['tl_athlete_category']['redirect_legend']  = 'Redirect settings';
$GLOBALS['TL_LANG']['tl_athlete_category']['protected_legend'] = 'Access protection';
