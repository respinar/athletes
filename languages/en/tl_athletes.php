 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_athletes']['new']        = array('New Athletes', 'Add a new athletes');
$GLOBALS['TL_LANG']['tl_athletes']['show']       = array('Athletes details', 'Show the details of athletes ID %s');
$GLOBALS['TL_LANG']['tl_athletes']['edit']       = array('Edit athletes', 'Edit athletes ID %s');
$GLOBALS['TL_LANG']['tl_athletes']['editheader'] = array('Edit athletes settings', 'Edit athletes settings ID %s');
$GLOBALS['TL_LANG']['tl_athletes']['copy']       = array('Copy athletes', 'Copy athletes ID %s');
$GLOBALS['TL_LANG']['tl_athletes']['delete']     = array('Delete athletes', 'Delete athletes ID %s');
